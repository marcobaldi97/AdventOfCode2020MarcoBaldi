...
function puzzleDay14b(input:string[]){
    class MemoryAllocator {
        ...
        public allocateMem(bitMask:string, input:string){
            ...
            let locations:number[] = applyBitMask(bitMask, loc);
    ...
    function applyBitMask(bmask:string, val:number):number[]{
...
function test14b(){
    ...
    console.log('----------------------------------START----------------------------------');
    console.log(puzzleDay14b(myLines));
};
test14b();
